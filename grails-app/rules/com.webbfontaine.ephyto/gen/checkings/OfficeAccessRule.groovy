 ...
 */
class OfficeAccessRule implements Rule {
    ...
    OfficeAccessRule(String codeField, String nameField, String partyNameField, Class domainClass, boolean useQueryCache = true, String userPropName) {
