...
<p>
    ${message(code: "ephtytoGen.mail.header",default:  "NE PAS REPONDRE S'IL VOUS PLAÎT. CECI EST UN MESSAGE DE NOTIFICATION AUTOMATIQUE ENVOYE PAR LE PORTAIL GUCE CI")}
</p>
<p>
    ${raw(mailMsgBody)}
</p>
<br/>
<p>
    ${message(code: "ephtytoGen.mail.msg.footer", default:  """Si vous rencontrez un problème avec le portail GUCE CI, contactez s'il vous plaît le support technique à <a href="mailto:support@guce.gouv.ci">support@guce.gouv.ci</a>
<br/>
<br/>
Equipe GUCE CI
<br/>
